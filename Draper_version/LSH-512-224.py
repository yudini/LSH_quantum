...
def msg_exp_even(eng,msg_e_l,msg_e_r,msg_o_l,msg_o_r,ancilla,ancilla2):
    ...
    for i in range(8):
        msg_e_l[64 * i:64 * (i + 1)] = inDraper(eng, msg_o_l[64 * i:64 * (i + 1)], msg_e_l[64 * i:64 * (i + 1)],
                                                ancilla[i], ancilla2[i], 64)
        msg_e_r[64 * i:64 * (i + 1)] = inDraper(eng, msg_o_r[64 * i:64 * (i + 1)], msg_e_r[64 * i:64 * (i + 1)],
                                                ancilla[i + 8], ancilla2[i + 8], 64)
